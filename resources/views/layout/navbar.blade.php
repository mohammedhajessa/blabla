  ...
  <ul class="navbar-nav flex-row align-items-center ms-auto">
    ...
    <li class="nav-item navbar-dropdown dropdown-user dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end">
        <li>
          <a class="dropdown-item mt-0" href="javascript:void(0);">
            <div class="d-flex align-items-center">
              ...
              <div class="flex-grow-1">
                @if(Auth::guard('driver')->check())
                <h6 class="mb-0">{{ Auth::guard('driver')->user()->name }}</h6>
        ...
        <li>
          <a class="dropdown-item" href="{{ route('driver.editProfile') }}">
            <i class="ti ti-settings me-3 ti-md"></i><span class="align-middle">Settings</span>
          </a>
        </li>
        <li>
          <a class="dropdown-item" href="{{ route('driver.cars') }}">
            <i class="ti ti-car me-3 ti-md"></i><span class="align-middle">My Car</span>
          </a>
        </li>
        @elseif(Auth::check())
        <li>
